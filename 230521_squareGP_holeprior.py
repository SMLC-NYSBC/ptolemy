...
while progress < 460:
    ...
    df['posterior'] = df.GP_probs # df.prior_score # * df.GP_probs
...
pickle.dump([hole_ctfs, square_hole_ctfs], open('m23feb16a_results/230610_testhparam_cutoff3.5_squaregp_holeprior_gt_75.pkl', 'wb'))
